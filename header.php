...
<html lang="en">
<head>
    <title>St. Wilfred's College Ajmer</title>
    <meta charset="UTF-8">
    <meta name="description" content="Wilfred's College">
    <meta name="keywords" content="Mechanical, Civil, E.C, C.S">
    ...
    <div class="container">
        ...
        <div class="header-info">
            ...
            <div class="hf-item">
                ...
                <p><span>Find us:</span>Near Balaji Temple, Gegal, Jaipur Rd, Ajmer, Rajasthan 305023</p>
            </div>
        </div>

        <a href="index.html" class="site-logo"><img src="assets/img/logo.jpg" alt=""></a>
    </div>
</header>
...
<nav class="nav-section">
    <div class="container">
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu"><a href="index.php">About Us</a>
                <ul class="sub-menu-about">
                    <li class="sub-about-item"><a href="our-legacy.php">Our legacy</a></li>
                    <li class="sub-about-item"><a href="vision-mission.php">vision & mission</a></li>
                    <li class="sub-about-item"><a href="management-committee.php">Management & Committee</a></li>
                    <li class="sub-about-item"><a href="from-the-secretary-desk.php">From the secretary desk</a></li>
                    <li class="sub-about-item"><a href="certificate-and-affiliation.php">Certificate & affiliation</a></li>
...
<section class="hero-section">
    <div class="hero-slider owl-carousel">
        <div class="hs-item set-bg" data-setbg="assets/img/wilfred.jpg">
            <div class="hs-text">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
        ...
        <div class="hs-item set-bg" data-setbg="assets/img/group.jpg">
            <div class="hs-text">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
        ...
        <div class="hs-item set-bg" data-setbg="assets/img/sir.jpg">
            <div class="hs-text">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
