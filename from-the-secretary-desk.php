...
<div class="container">
    <div class="header-margin">
        <h2>From The Secretary Desk</h2>
    </div>
    <div class="desk-para">
        <p>
            <strong>

                The educational scenario in the recent past has witnessed manifold changes in the academic inclinations of the young minds. The ever-growing globalisation and resurgence of open economy have led to an enormous demand for qualified youth bearing academic excellence.
            </strong>
        </p>
        <p>
            <strong>
    ...
    <div class="desk-secretary">
        <div class="head-secretary">
            <h2>
                Wishing you success in all your endeavors.</h2>
        </div>
        <div class="head-secretary">
            <h2>Dr. Keshav Badaya</h2>
        </div>
        <div class="head-secretary">
            <h2>Honorable Secretary</h2>
        </div>
    </div>
...
<div class="file-footer">
    <p>St. Wilfred's Group of College</p>
</div>
-->
